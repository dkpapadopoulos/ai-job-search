...
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(bun --version), Bash(bun run .agents/skills/*/cli/src/cli.ts *), Bash(python tools/job_key.py:*), Bash(python3 tools/job_key.py:*), WebFetch, WebSearch, Agent, AskUserQuestion, mcp__tavily-mcp__tavily_search, mcp__tavily-mcp__tavily_extract, mcp__tavily-mcp__tavily_research
---
